    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {conversations.map((item) => (
          <div
            key={item.id}
            className={`flex items-center justify-between rounded-2xl border px-4 py-3 text-sm text-slate-100 shadow-sm backdrop-blur transition ${
              item.unreadCount > 0
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-slate-300">
                Private room {item.isMuted ? "бд Muted" : ""}
              </p>
            </div>
            <div className="flex items-center gap-2">
              {item.unreadCount > 0 && (
        ...
        {conversations.length === 0 && (
          <div className="rounded-2xl border border-dashed border-white/20 bg-white/5 p-4 text-sm text-slate-300">
            ...
            <p>or inside a room бк go stir things up.</p>
